...
[
	...
	{
		name: "Book worm", triggers: [
			"Earn a Plot Point and Add a d6 to Trouble when you leave a social scene you're in to indulge in a book.",
			"Spend a Plot Point to Reveal useful information you read about in a book.",
			"Spend a Plot Point when you understand something more about a situation to Recover your own AFRAID or INSECURE Stress.  Knowledge is power."
		]
	},
	{
	...
	{
		name: "Confident", triggers: [
			"Earn a Plot Point wen you Choose to act first in a situation.",
			"Earn a Plot Point and Add a d6 to Trouble when you Give In in a social Contest.",
			"Spend a Plot Point to Reroll a die in a social situation."
		]
	},
	{
	...
	{
		name: "Distraught", triggers: [
			"Earn a Plot Point when your behavior or appearance attracts negative attention.",
			"Earn a Plot Point for another Lead and Increase your AFRAID or ANGRY Stress pool against them when you project your own dark mood through words or actions.  Misery loves company.",
			"Spend a Plot Point to Recover your own AFRAID, ANGRY, or INSECURE stress.  You're used to it."
		]
	},
	{
		name: "Down with the kids", triggers: [
			"Earn a Plot Point when you Choose to side with a kid in a conflict with an adult.",
			"Spend a Plot Point to Reroll a die when attempting to influence a kid.",
			"Spend a Plot Point to Gain a d8 Relationship with a kid Feature for the rest of the scene."
		]
	},
	{
	...
	{
		name: "Famous", triggers: [
			"Earn a Plot Point and Give your opposition a d6 when your reputation precedes you.",
			"Spend a Plot Point to Reroll a die when your opposition is part of your own peer group.",
			"Spend a Plot Point to Gain a 2d8 Extra (a lucky fan) for the rest of the scene."
		]
	},
	{
	...
	{
		name: "Heroic reputation", triggers: [
	...
	{
		name: "License to drive", triggers: [
			"Spend a Plot Point to Reveal that you have access to a vehicle that (pick two) is big enough to fit everyone in your group, is located nearby, and has a full tank.  Use it as a d8 Useful Detail for the rest of the scene.",
			"Add a d8 to the Trouble pool to arrive at a scene you weren't in (if accessible by car).",
			"Spend a Plot Point to Reroll a die when you're the guy or gal at the wheel."
		]
	},
	{
	...
	{
		name: "Persistent", triggers: [
			"Earn a Plot Point and Add a d6 to Trouble when you get too pushy with someone you know you shouldn't.",
			"Spend a Plot Point to Reroll any die when you repeat a Test or Contest you've taken Stress from previously in the scene.",
			"Spend a Plot Point to Decrease your opposition's ANGRY or EXHAUSTED pool against you as a result of your persistence."
		]
	},
	{
		name: "Popular", triggers: [
			"Earn a Plot Point when you Choose to be distracted by your own fame.",
			"Spend a Plot Point to Reroll a die in a Test or Contest involving people who aren't already your fans.",
			"Spend a Plot Point to Gain a d8 Relationship for one scene with a Feature with whom you don't already have a relationship."
		]
	},
	{
	...
	{
		name: "Socially invisible", triggers: [
			"Earn a Plot Point when you Choose to make yourself the subject of public attention.",
			"Spend a Plot Point to Reveal that you were there, in a scene, all along.",
			"Add a d6 to Trouble to Gain a 2d8 Location for the remainder of the Scene."
		]
	},
	{
		name: "Teacher's pet", triggers: [
			"Earn a Plot Point when you Choose to involve an adult in a situation.",
			"Spend a Plot Point to Reroll a die when attempting to influence an adult.",
			"Spend a Plot Point to Gain a d8 Relationship with an adult Feature for the rest of the scene."
		]
	},
	{
		name: "Team player", triggers: [
			"Earn a Plot Point when you Choose to follow instruction, stick to the game plan, or maintain strict discipline when it would benefit you more to do otherwise.",
			"Spend a Plot Point to allow another Lead or Feature to Reroll a die in a Test or Contest that you have Aided.",
			"Spend a Plot Point to Recover another Lead or Feature's ARAID, EXHAUSTED, or INSECURE Stress with your support."
		]
	},
	{
		name: "Underage", triggers: [
			"Spend a Plot Point to Reroll any die in situations where your apparent age is the deciding factor.",
			"Earn a Plot Point and Add a d6 to Trouble when your apparent youth makes a situation worse.",
			"Spend a Plot Point to Decrease your opponent's AFRAID or INJURED Stress pool.  How could they be so mean to a kid?"
		]
	},
	{
	...
	{
		name: "Wierdar", triggers: [
			"Earn a Plot Point when you Choose to ignore any logical explanation.",
			"Add a d6 to Trouble to Reroll any die in WIERDAR roll.",
			"Add a d10 to Trouble to Reroll a second die in WIERDAR roll."
		]
	},
	{
	...
	{
		name: "Award: Best body", triggers: [
			"Add a d6 to Trouble to Reroll a die in a BEST BODY roll.",
			"Earn a Plot Point when you Choose to use brawn or beauty over brains.",
			"Spend a Plot Point to Decrease your opponent's INJURED or EXHAUSTED Stress pool."
		]
	},
	{
		name: "Award: Best coach", triggers: [
			"Spend a Plot Point to Gain a 2d8 Extra from your team for the rest of the scene.",
			"Add a d6 to Trouble to Decrease your opponent's EXHAUSTED or INJURED Stress pool.",
			"Earn a Plot Point when you come to the aid of a team player in trouble."
		]
	},
	{
		name: "Award: Best smile", triggers: [
			"Add a d6 to Trouble to Reveal that a Feature has or had a crush on you.",
			"Spend a Plot Point to Gain a d8 Relationship with a Feature for the rest of the scene.",
			"Add a d10 to Trouble to Reroll a die in a Contest with someone who is attracted to you."
		]
	},
	{
		name: "Award: Best sport", triggers: [
			"Earn a Plot Point when you Choose to confront a situation head on and honorably rather than sneaking behind someone's back.",
			"Earn a Plot Point and Give your opponent a d6 when your sportsmanship gives them an advantage against you.",
			"Spend a Plot Point to Decrease your opponent's ANGRY or INSECURE Stress pool."
		]
	},
	{
		name: "Award: Class clown", triggers: [
			"Add a d6 to Trouble to Decrease your opponent's AGRAID or ANGRY Stress pool.",
			"Add a d10 to Trouble to Reveal a prank that you had planned all this time.",
			"Earn a Plot Point and Give your opponent a d6 when your antics get you in trouble."
		]
	},
	{
		name: "Award: Cutest couple", triggers: [
			"Spend a Plot Point to let your significant other join a scene you're in.",
			"Earn a Plot Point when you Choose to stand up for your significant other.",
			"Add a d6 to Trouble to Reroll a die when acting in a way that benefits your significant other."
		]
	},
	{
		name: "Award: Favorite teacher", triggers: [
			"Earn a Plot Point when you Choose to step in and act for a student who isn't in your class.",
			"Add a d6 to Trouble and Gain a d8 Relationship with a student or a 2d8 Extra when you challenge the school's status quo in front of the kids.",
			"Earn a Plot Point and Decrease your own INSECURE or ANGRY Stress pool when dressing down a student."
		]
	},
	{
		name: "Award: Most Dependable", triggers: [
			"Spend a Plot Point to let another Lead or Feature Reroll a die when you are Aiding their Test or Contest.",
			"Earn a Plot Point when you Choose to help someone at your own expense.",
			"Add a d6 to Trouble to arrive in a scene just in time to help."
		]
	},
	{
		name: "Award: Most likely to go to jail", triggers: [
			"Earn a Plot Point when you Choose to do something to upset an authority figure.",
			"Add a d6 to Trouble to Reroll a die in a Contest against an authority figure.",
			"Add a d10 to Trouble to Reveal some illicit item you had stashed somewhere."
		]
	},
	{
		name: "Award: Most likely to succeed", triggers: [
			"Spend a Plot Point to Reroll a die against an opponent with more dice in their pool (including Trouble).",
			"Add a d6 to Trouble to Reroll a second die against an opponent with more dice in their pool (including Trouble).",
			"Give your opposition a d6 to roll against you to Reroll a third die when they have more dice in their pool (including Trouble)."
		]
	},
	{
		name: "Award: Most school spirit", triggers: [
			"Spend a Plot Point to Gain a d8 Relationship with a jock Feature for the scene.",
			"Earn a Plot Point when you Choose to start trouble with another school's sports team, admin, or students.",
			"Add a d6 to Trouble when you Reveal that you have access to a restricted or unorthodox area of school."
		]
	},
	{
		name: "Award: Strictest teacher", triggers: [
			"Spend a Plot Point to Reveal evidence of a student's wrongdoing.",
			"Add a d6 to Trouble to Increase your ANGRY or INSECURE Stress pool against students.",
			"Earn a Plot Point when you Choose to employ cruel and unusual disciplinary methods."
		]
	},
	{
		name: "Award: Toughest coach", triggers: [
			"Add a d6 to Trouble to Increase your AFRAID or EXHAUSTED Stress pool.",
			"Spend a Plot Point to allow another Lead or Feature to Reroll any die in a Test or Contest your'e Aiding them in.  Discipline gets results when you're there to enforce it.",
			"Earn a Plot Point when you Choose to allow your team to undermine your authority."
		]
	}
];
...
[
	{
		name: "Heritage: Almeracian", limits: ["psychic"], triggers: [
	...
	{
		name: "Heritage: Atlantean", limits: ["dehydration"], triggers: [
	...
	{
		name: "Heritage: Cybernetic", limits: ["electricity"], triggers: [
	...
	{
		name: "Heritage: Kryptonian", limits: ["kryptonite", "magic"], triggers: [
	...
	{
		name: "Heritage: Magical", limits: ["mute", "binding"], triggers: [
	...
	{
		name: "Heritage: Martian", limits: ["fire"], triggers: [
